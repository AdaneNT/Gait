...
Fs = 20
segment_size =  128# Fs*6.4 # window size=n_time steps=frame size
step_size =  25 # Fs*1.25  # step size 
n_features = 3     
...
def Classes():
    ...
    Retrieve the scores of each gait class for a given input CSV file
    ---
    tags:
      - name: ""
        description: "Gait activity estimations for a given CSV file"
